...
use classes\Room;
  ...
  if (isset($_POST['check_in_date']) && isset($_POST['check_out_date']) && isset($_POST['guest_count']) && isset($_POST['children_count'])) {
    ...
    // $available_rooms = Room::filterAvailableRooms($con, $check_in_date, $check_out_date, $guest_count, $children_count);
  }
      ...
      <?php 
        if (isset($_POST['check_in_date']) && isset($_POST['check_out_date']) && isset($_POST['guest_count']) && isset($_POST['children_count'])){
          ...
          <form class="grid" action="filterd_room.php" method="post">
            ...
            <input type="number" placeholder="Childern count" name="children_count" value="<?php echo $children_count; ?>" min="0" required>
                    ...
                    <h4 style="text-align: right; color: rgb(255, 0, 255);">
                      <?php 
                        if (isset($_POST['check_in_date']) && isset($_POST['check_out_date']) && isset($_POST['guest_count']) && isset($_POST['children_count'])){
                          ...
                          echo $availableRoomCount . " Rooms Left" ;
                        }else{
                          $availableRoom = Room::read($con, $room['room_id']);
                          echo $availableRoom['number_of_rooms']. " Rooms Left";
                        }
                      ?>
                    </h4>
                    <p>
